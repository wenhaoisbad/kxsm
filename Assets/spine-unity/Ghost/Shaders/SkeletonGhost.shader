	  ...
	  Cull Off
        ...
        Pass 
        {
            Tags {"LightMode" = "Always"}                      // This Pass tag is important or Unity may not give it the correct light information.
                ...
                //#pragma multi_compile_fwdbase                       // This line tells Unity to compile this pass for up base.
                ...
                fixed4 frag(vertex_output i) : COLOR
                {
                    ...
                    fixed4 c;
					c.rgb = (UNITY_LIGHTMODEL_AMBIENT.rgb * tex.rgb);       // Ambient term. Only do this in up Base. It only needs calculating once.
                    c.rgb += tex.rgb; // Diffuse and specular.
					//Unity 4: c.rgb = (UNITY_LIGHTMODEL_AMBIENT.rgb * tex.rgb * 2);       // Ambient term. Only do this in up Base. It only needs calculating once.
